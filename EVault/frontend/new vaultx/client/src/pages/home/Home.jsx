    ...
    <div className="home-container">
      ...
      <div className="section1">
        <div className="justice">
          <img
            src={m} // Replace with the actual path to your image
        ...
        <div className="justice">
          <div className="image-container">
            <img
              src={download} // Replace with the actual path to your second image
        ...
        <div className="justice">
          <img
            src={sih} // Replace with the actual path to your image
            alt="Description of the image"
            // Adjust the width and maxWidth as needed
            />
        </div>
